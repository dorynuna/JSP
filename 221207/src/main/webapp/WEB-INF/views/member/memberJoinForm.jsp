				...
				<div>
					<table border="1">
						...
						<tr>
							...
							<td>
							<input type="password" id="password" name="passwordChk" required="required">
							</td>
						</tr>
						<tr>
							<th width="150">나이</th>
...
function idChk() { // 아이디 중복체크 Ajax로 비교 / idChk : 대문자!!!!!!!!!!!
	let id = document.getElementById("memberId").value;
	let url = 'AjaxMemberIdCheck.do?id='+id; 
	fetch(url).then((response)=>response.text()) //then 뒤에 연결되야하는데 ;쓰면 끊김
